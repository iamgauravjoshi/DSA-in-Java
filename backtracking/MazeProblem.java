...
public class MazeProblem {
    public static void main(String[] args) {
        ...
        System.out.println("Total ways: " + countPaths(i, j));
        System.out.println("\n");
    ...
    /* ------- Get list of possible paths to reach destination, not diagonal ------- */
    ...
    /* ------- Count total ways to reach the final destination, not diagonal ------- */
    ...
    /* ------- Print possible paths to reach destination, not diagonal ------- */
