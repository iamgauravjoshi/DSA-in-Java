/*
PROBLEM -> Given an integer n, return all the n digit numbers in increasing order, such that their digits are in strictly increasing order(from left to right).
...
public class IncreasingOrderDigit {
    public static void main(String[] args) {
        System.out.println("Increasing Digit Numbers");
    }
