...
class CeilOfAnElement {
    ...
    public static void main(String[] args) {
        CeilOfAnElement s = new CeilOfAnElement();
        int[] arr1 = {1, 2, 8, 10, 10, 12, 19};
        int[] arr2 = {1, 3, 5, 6};

        System.out.println(s.findCeil(arr1, 5));
        System.out.println(s.findCeil(arr1, 20));
        System.out.println(s.findCeil(arr1, 0));

        System.out.println();

        System.out.println(s.findCeil(arr2, 5));
        System.out.println(s.findCeil(arr2, 2));
        System.out.println(s.findCeil(arr2, 7));
    }
